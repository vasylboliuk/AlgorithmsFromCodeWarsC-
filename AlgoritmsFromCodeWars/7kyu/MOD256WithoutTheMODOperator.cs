...
namespace AlgoritmsFromCodeWars._7kyu
{
    public class MOD256WithoutTheMODOperator
    {
        ...
        ///  wrote a program and needed the remainder of the division by 256. 
        ...
        /// For all, who say, this would be a duplicate: No, this is no duplicate! There are two katas, 
        /// in that you have to write a general method for MOD without %. But this kata is only for MOD 256. 
        /// And so you can create also other specialized solutions. ;-)
